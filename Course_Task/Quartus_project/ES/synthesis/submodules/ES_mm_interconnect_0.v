...
module ES_mm_interconnect_0 (
	...
	wire  [92:0] reg32_avalon_interface_0_avalon_slave_0_agent_rf_source_data;                       // reg32_avalon_interface_0_avalon_slave_0_agent:rf_source_data -> reg32_avalon_interface_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [92:0] reg32_avalon_interface_0_avalon_slave_0_agent_rsp_fifo_out_data;                    // reg32_avalon_interface_0_avalon_slave_0_agent_rsp_fifo:out_data -> reg32_avalon_interface_0_avalon_slave_0_agent:rf_sink_data
	...
	wire  [91:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> reg32_avalon_interface_0_avalon_slave_0_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // reg32_avalon_interface_0_avalon_slave_0_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> reg32_avalon_interface_0_avalon_slave_0_agent:cp_channel
	...
	wire  [91:0] reg32_avalon_interface_0_avalon_slave_0_agent_rp_data;                              // reg32_avalon_interface_0_avalon_slave_0_agent:rp_data -> router_003:sink_data
	...
	wire  [91:0] router_src_data;                                                                    // router:src_data -> nios2_qsys_0_data_master_limiter:cmd_sink_data
	...
	wire  [91:0] nios2_qsys_0_data_master_limiter_cmd_src_data;                                      // nios2_qsys_0_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [91:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_qsys_0_data_master_limiter:rsp_sink_data
	...
	wire  [91:0] nios2_qsys_0_data_master_limiter_rsp_src_data;                                      // nios2_qsys_0_data_master_limiter:rsp_src_data -> nios2_qsys_0_data_master_agent:rp_data
	...
	wire  [91:0] router_001_src_data;                                                                // router_001:src_data -> nios2_qsys_0_instruction_master_limiter:cmd_sink_data
	...
	wire  [91:0] nios2_qsys_0_instruction_master_limiter_cmd_src_data;                               // nios2_qsys_0_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [91:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_qsys_0_instruction_master_limiter:rsp_sink_data
	...
	wire  [91:0] nios2_qsys_0_instruction_master_limiter_rsp_src_data;                               // nios2_qsys_0_instruction_master_limiter:rsp_src_data -> nios2_qsys_0_instruction_master_agent:rp_data
	...
	ES_mm_interconnect_0_router router (
	...
	ES_mm_interconnect_0_router_001 router_001 (
	...
	ES_mm_interconnect_0_router_002 router_002 (
	...
	ES_mm_interconnect_0_router_002 router_003 (
	...
	ES_mm_interconnect_0_router_004 router_004 (
	...
	ES_mm_interconnect_0_router_004 router_005 (
	...
	ES_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                          //        clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	ES_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                 //        clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset),              //  clk_reset.reset
	...
	ES_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ES_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ES_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ES_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ES_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ES_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ES_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ES_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ES_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ES_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ES_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
