...
ARCHCCFLAGS	:= -mhw-mul -mno-hw-div -I "C:/intelFPGA_lite/18.1/nios2eds/components/altera_nios2/HAL/inc/" -DSYSTEM_BUS_WIDTH=32 -DALT_SINGLE_THREADED -D_JTAG_UART_BASE=135200u
ARCHLDFLAGS	:= --defsym nasys_stack_top=0x186a0 --defsym nasys_program_mem=0x0 --defsym nasys_data_mem=0x0
...
# Files
HDRS		:=
SRCS		:= ../NoisII_c_file/main.c amp/lib/src/niosII_jtag_uart.c
...
# Files
SYS_FILE_SOF			:= "C:/Users/bimee/OneDrive/SoC/Course_Task/Quartus_project/output_files/QP_time_limited.sof"
